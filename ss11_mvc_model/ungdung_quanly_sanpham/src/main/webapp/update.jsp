...
<form class="form-horizontal" action="/product" method="post">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="product_id" name="product_id" placeholder="PRODUCT NAME" class="form-control input-md" required="" type="text" value="${pd.id}" readonly>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="product_name" name="product_name" placeholder="PRODUCT NAME" class="form-control input-md" required="" type="text" value="${pd.name}" >
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="product_price" name="product_price" placeholder="PRODUCT NAME" class="form-control input-md" required="" type="text" value="${pd.gia}" >
