...
<body>
<h1 style="text-align: center ; color: yellow">ADD NEW EMPLOYEE</h1>

<div class="container-fluid">
    <form class="row col-8  formEmployee border bg-dark " action="/employee?actionEmployee=addEmployee" method="post">
        <div class="col-md-6">
